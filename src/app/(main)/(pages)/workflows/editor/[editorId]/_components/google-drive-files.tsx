...
const GoogleDriveFiles = (props: Props) => {
    ...
    const reqGoogle = async () => {
        ...
        try {
            ...
            console.log("1. Initiating request to /api/drive...");
            ...
            if (response.data?.message?.files) {
                console.log("4. Files found:", response.data.message.files.length);
                console.log("5. First file example:", response.data.message.files[0]);
                
                toast({
                    description: `Found ${response.data.message.files.length} files`
                });
            } else {
                console.log("4. No files found in response");
            }
        } catch (error: any) {
